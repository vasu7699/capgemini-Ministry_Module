		...
		for(Scholarship s:scholarshipService.getAllScholarships()) {
			...
			//if(stdList.contains(student.getStudentId()))
				...
				if(grant_Scholarship!=null) {
					String str="Scholarship is Granted "+"Student Id: "+ student.getStudentId()+" Student Name: "+student.getFullName()+" Scholarship Id: "+scholarship.getScholarshipId()+"  Scholarship Name: "+scholarship.getScholarshipName() +" Scholarship Status: " +student.getAppStatus();
					return str;
				}
				else {
					String str="Scholarship is Not Granted"+"Student Id: "+ student.getStudentId()+" Student Name: "+student.getFullName()+"  Scholarship Id: "+scholarship.getScholarshipId()+"  Scholarship Name: "+scholarship.getScholarshipName()+" Scholarship Status: " +student.getAppStatus();
					return str;
				}
			}
			}
